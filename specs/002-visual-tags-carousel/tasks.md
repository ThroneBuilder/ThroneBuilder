...
- [x] T005 [P] [US1] Add `tags: ["family"]` frontmatter field to `src/content/blog/2026-05-27-hello-thronebuilder.md`
- [x] T006 [P] [US1] Add `tags: ["legos"]` frontmatter field to `src/content/blog/2026-05-27-video-example.md`
- [x] T007 [P] [US1] Add JS-detection inline script to `src/layouts/BaseLayout.astro` — add `<script>document.documentElement.classList.add('js')</script>` as the first element inside `<head>` (runs synchronously before paint, no FOUC)
